  ...
  return (
    <section className="rounded-3xl border border-[#e9e0d4] bg-white p-5 shadow-sm">
      <div className="mb-4 flex items-center justify-between">
        <h3 className="text-xl font-black tracking-tight text-[#122a3f]">Events & Schedule</h3>
      ...
      <div className="space-y-3">
        {events.map((event) => (
          <article key={event.id} className="rounded-2xl border border-[#e9e0d4] p-3">
            <div className="flex items-start justify-between gap-2">
              <div>
                <h4 className="font-bold text-[#122a3f]">{event.title}</h4>
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              ...
              <button className="rounded-lg border border-[#d8cec5] bg-white px-2.5 py-1 text-xs font-semibold text-slate-700 transition hover:bg-[#faf7f2]">Edit Event</button>
              <button className="rounded-lg border border-[#d8cec5] bg-white px-2.5 py-1 text-xs font-semibold text-slate-700 transition hover:bg-[#faf7f2]">Send Reminder</button>
            </div>
          </article>
        ))}
      </div>
