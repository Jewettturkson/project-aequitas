...
export default function ProjectCard({ project }: ProjectCardProps) {
  return (
    <article className="group overflow-hidden rounded-3xl border border-[#e9e0d4] bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-md">
      ...
      <div className="p-5">
        ...
        <h3 className="mb-2 text-xl font-bold text-[#122a3f]">{project.title}</h3>
