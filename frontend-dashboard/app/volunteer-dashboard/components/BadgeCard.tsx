...
export default function BadgeCard({ badge }: BadgeCardProps) {
  return (
    <article className="rounded-2xl border border-[#e9e0d4] bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
      <div className="mb-3 inline-flex rounded-full bg-amber-100 p-2 text-amber-700">
        <Award className="h-4 w-4" />
      </div>
      <h3 className="text-lg font-bold text-[#122a3f]">{badge.name}</h3>
